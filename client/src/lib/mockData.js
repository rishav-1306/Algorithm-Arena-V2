...
export const mockCurrentUser = {
  ...
  id: 'u_001',
  username: 'devmaster',
  role: 'clan-chief', // change to 'user' to test non-admin views
};
...
export const mockUsers = [
  ...
  },
  {
    _id: "u_003",
    username: "binaryBoss",
    email: "binaryboss@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_004",
    username: "codeNinja42",
    email: "codeninja@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_005",
    username: "stackOverflow_fan",
    email: "stackoverflow@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_006",
    username: "recursionKing",
    email: "recursionking@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_007",
    username: "dpWizard",
    email: "dpwizard@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_008",
    username: "graphGuru",
    email: "graphguru@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_009",
    username: "bitManipulator",
    email: "bitman@iter.ac.in",
    role: "user",
  },
  {
    _id: "u_010",
    username: "heapHero",
    email: "heaphero@iter.ac.in",
    role: "user",
  },
];
...
export const mockGlobalNotice = {
  _id: "gn_001",
  content:
    "🏆 Annual Algo-Coding Championship starts next week! Register now in the Missions tab.",
